    ...
    <body id="page-top">
        ...
        <header class="masthead d-flex">
            <div class="container text-center my-auto">
             <h2 class="mb-1" style="background-color:#FBFAF5;">LITERATURE</h2>
...
<input type="hidden" name="librarybookPrice" value= "{{$prods->librarybookPrice}}">
                    <div class="col-lg-4">
                        <a class="portfolio-item" href="#!">
                            ...
                            <img  class="img-fluid"  style=width:400px;height:600px;  src="{{ URL ::asset('assets/project_img/'.$prods->pimage) }}" alt="..." />
                            <a  class="btn btn-primary" href="/issue{{$prods->id}}" onclick="return confirm('Did you want to issue this book?')">RENT</a>
